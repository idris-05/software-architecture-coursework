...
public class Calcul {
    ...
    public static long somme(int c, int d) {
        // Interpreter expects postfix notation.
        return evaluate(c + " " + d + " +");
    }
    ...
    public static long random() {
        // Keep legacy behavior: random integer in [0, 9999].
        return RANDOM.nextInt(10000);
    }

    /**
     * Centralizes the call to the interpreter so the GUI only depends on this
     * adapter.
     */
